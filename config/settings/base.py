...
ROOT_DIR = environ.Path(__file__) - 3  # (tradgram/config/settings/base.py - 3 = tradgram/)
APPS_DIR = ROOT_DIR.path('tradgram')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///tradgram'),
}
...
MIGRATION_MODULES = {
    'sites': 'tradgram.contrib.sites.migrations'
}
...
ADMINS = [
    ("""ByungJoon Song""", 'pat@pat-earn.com'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'tradgram.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'tradgram.users.adapters.SocialAccountAdapter'
...
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'tradgram.users.serializers.SignUpSerializer'
}